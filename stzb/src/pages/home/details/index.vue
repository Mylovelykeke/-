<template>
  <div class="main">
        <skeleton selector="skeleton" bgcolor="#FFF" :flag="showSkeletonFlag">
            <div>
...
export default {
    ...
    onUnload() {
        dataArr2.pop()
        const dataNum = dataArr2.length
        this.showSkeleton = true
        if (!dataNum) return
        Object.assign(this.$data, dataArr2[dataNum - 1])
    },
     methods:{
